...
<script lang="ts">
  let { activeView, selectedItem, items }: {
...
.entity-group-swatch.entity-email { background-color: var(--entity-email); border-color: var(--entity-email); }
.entity-group-swatch.entity-person { background-color: var(--entity-person); border-color: var(--entity-person); }
.entity-group-swatch.entity-org { background-color: var(--entity-org); border-color: var(--entity-org); }
.entity-group-swatch.entity-amt { background-color: var(--entity-amt); border-color: var(--entity-amt); }
.entity-group-swatch.entity-phone { background-color: var(--entity-phone); border-color: var(--entity-phone); }
.entity-group-swatch.entity-api_key { background-color: var(--entity-api-key); border-color: var(--entity-api-key); }
